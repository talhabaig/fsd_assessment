  ...
  return (
    <div className="w-full">
      <div className="relative">
        ...
        <div className="flex justify-evenly w-full mt-[-14rem] ">
          ...
          <div className="inline-flex p-[42px_50.906px_46px_51.094px] justify-center items-center  bg-white shadow-[0px_0px_16px_0px_rgba(0,0,0,0.12)]">
