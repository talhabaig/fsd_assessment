      ...
      <div className="px-8 md:px-16 lg:px-28">
        ...
        <div className="3xl:container 3xl:max-w-[1500px] 3xl:mx-auto md:pl-12 xl:pl-20 pt-16 md:pt-48 pb-24">
          <span className="relative">
            ...
            <div className="bg-white p-4 lg:py-[26.812px] lg:px-[31.543px] flex flex-col items-start gap-[15.772px] absolute z-20 left-[-50px] lg:left-[-100px] bottom-[40px]">
              <span className="font-inter text-gunmetal text-[24px] lg:text-[47.729px] font-normal leading-[40px] lg:leading-[63.02px] capitalize">
                #1
              </span>
            </div>
          </span>
      ...
      <div className="py-48">
        <div className="relative">
          ...
          <SvgImage
            ...
            width=""
          />
          <div className="bg-white w-[250px] md:w-[640px] md:h-[400px] flex flex-col justify-center items-start gap-4 md:gap-[44px] p-4 md:p-[45px] absolute z-20 bottom-[-200px] md:bottom-[-140px] left-[40px] md:left-[70px]">
            <div className="flex flex-col gap-[10px] md:gap-[19px] items-start">
              <div className="text-spacecadet font-playfair-display text-[20px] md:text-[38px] lg:text-[48px] font-bold leading-[28px] md:leading-[50px] lg:leading-[62px] capitalize">
            ...
            <div className="flex items-center justify-center gap-[99px]">
              <div className="basis-[85%] lg:basis-[64%] flex flex-col gap-2">
                <div className="bg-white flex justify-center items-center shrink-0 px-2 lg:px-3 py-3 gap-1 md:gap-2 lg:gap-3">
                  ...
                  >
                    <button className="w-full text-white flex flex-col p-2 lg:px-[21.053px] lg:py-[10.526px] items-center gap-[12px] bg-oceanBlue transition-none text-sm md:text-[16.842px]">
                  ...
                  >
                    <button className="w-full flex flex-col justify-center items-center gap-[10.526px] px-2 py-[7px] lg:px-[21.053px] lg:py-[10.526px] border-[1px] border-cadet text-darygray hover:bg-oceanBlue hover:text-white transition-none">
