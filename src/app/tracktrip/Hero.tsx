    ...
    <div className="w-full">
      <div className="relative">
        ...
        <div className="xs:flex-col md:flex-row md:flex md:justify-evenly md:w-full xs:mt-[-7rem] md:mt-[-14rem] ">
          ...
          <div className="xs:w-[330px]  md:w-[390px] lg:w-[580px] flex  xs:m-auto md:m-0 xs:p-[21px_25px_21px_25px] lg:p-[42px_50.906px_46px_51.094px] justify-center items-center  bg-white shadow-[0px_0px_16px_0px_rgba(0,0,0,0.12)]">
            <div className="flex flex-col items-center md:gap-7 xs:gap-3">
              ...
              <div className="flex gap-4">
                <input
                  type="text"
                  className="flex md:w-[150px] lg:w-[217px] xs:w-[120px] xs:px-3 xs:py-1 lg:px-6 lg:py-3 justify-center items-center gap-2.5 flex-shrink-0 border border-dashed border-slateBlue"
                  placeholder="Enter Trip ID"
                />

                <button className="flex md:w-[150px] lg:w-[217px] xs:w-[120px] xs:px-3 xs:py-1 md:px-6 md:py-3 justify-center items-center gap-2.5 flex-shrink-0 bg-oceanBlue text-white">
                  View Details
                </button>
              </div>
            </div>
